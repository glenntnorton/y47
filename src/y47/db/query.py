...
class Query(object):
    def execute(self, sql, args): raise NotImplementedError
...
class SQLiteQuery(Query):
    ...
    connection = property(_getConnection, _setConnection, None, None)


    def _execute(sql, args):
        pass
    execute = property(_execute, None, None, None)
